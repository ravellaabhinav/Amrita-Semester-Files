...
{
    clrscr( );
    int opr;   // display different operation of the calculator
    do
    {
        ...
        switch (opr)
        {
                ...
                break;
                case 3:
                multi( ); // call multi( ) function to rind the multiplication
                break;
                case 4:
                ...
                break;
                case 6:
                srt(); // call srt( ) function to find square Root of number
                break;
                case 7:
