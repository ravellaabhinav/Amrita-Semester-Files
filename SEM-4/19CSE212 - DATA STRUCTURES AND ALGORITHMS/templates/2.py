...
class HashTable:
    # This implementation uses two lists. One list, called slots, will hold the key items and a parallel list,
    # called data, will hold the data values. When we look up a key, the corresponding position in the data list will
    # hold the associated data value.
    def _init_(self, size, resolutionMethod):
        self.size = size
    ...
    # retrieves the item from the table based on the hashing. Print the starting slot for searching the key,
    # Returns True when key is found and False when the key is not found"
