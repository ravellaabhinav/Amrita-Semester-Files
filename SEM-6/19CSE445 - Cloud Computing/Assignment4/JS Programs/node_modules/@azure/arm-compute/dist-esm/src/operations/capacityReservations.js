...
export class CapacityReservationsImpl {
    ...
    listByCapacityReservationGroupPagingPage(resourceGroupName, capacityReservationGroupName, options) {
        return __asyncGenerator(this, arguments, function* listByCapacityReservationGroupPagingPage_1() {
            let result = yield __await(this._listByCapacityReservationGroup(resourceGroupName, capacityReservationGroupName, options));
    ...
    listByCapacityReservationGroupPagingAll(resourceGroupName, capacityReservationGroupName, options) {
        return __asyncGenerator(this, arguments, function* listByCapacityReservationGroupPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByCapacityReservationGroupPagingPage(resourceGroupName, capacityReservationGroupName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
